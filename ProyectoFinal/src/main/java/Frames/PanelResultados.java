...
public class PanelResultados extends JFrame {
	 ...
	 * Create the frame.
	 */
	public PanelResultados(List<CropsDto> a,String nc,String es,String cat,String subc,String fr,String fam,String ci,String cons,boolean selector ) {
		...
		JLabel lblNewLabel_2 = new JLabel("Resultados de favoritos");
		lblNewLabel_2.setFont( new Font( "Helvetica", Font.ITALIC, 48 ) );
		lblNewLabel_2.setBounds(493, 10,704, 81);
		panel.add(lblNewLabel_2);
		if(selector) {
			lblNewLabel_2.setText("Resultados de busqueda");
		}
	...
	panel_2.addMouseListener(new MouseListener() {
		...
		public void mouseClicked(MouseEvent e) {
			...
			//UniqueCrop.main(a.get(y*8+0).getCategory(),a.get(y*8+0).getClase(),a.get(y*8+0).getCommonName(),a.get(y*8+0).getConsistency(),a.get(y*8+0).getCropCycle(),a.get(y*8+0).getDivision(),a.get(y*8+0).getFamily(),a.get(y*8+0).getFruitType(),a.get(y*8+0).getGenus(),a.get(y*8+0).getOrder(),a.get(y*8+0).getRemarks(),a.get(y*8+0).getSpecieName(),a.get(y*8+0).getSubCategory(),a.get(y*8+0).getSubClass(),a.get(y*8+0).getSubDivision(),a.get(y*8+0).getSubFamily(),a.get(y*8+0).getSuperorder(),a.get(y*8+0).getSynonyms(),selector);
	...
	panel_2_1_1_4.addMouseListener(new MouseListener() {
		...
		public void mouseClicked(MouseEvent e) {
			// TODO Auto-generated method stub
			//UniqueCrop.main(a.get(y*8+5).getCategory(),a.get(y*8+5).getClase(),a.get(y*8+5).getCommonName(),a.get(y*8+5).getConsistency(),a.get(y*8+5).getCropCycle(),a.get(y*8+5).getDivision(),a.get(y*8+5).getFamily(),a.get(y*8+5).getFruitType(),a.get(y*8+5).getGenus(),a.get(y*8+5).getOrder(),a.get(y*8+5).getRemarks(),a.get(y*8+5).getSpecieName(),a.get(y*8+5).getSubCategory(),a.get(y*8+5).getSubClass(),a.get(y*8+5).getSubDivision(),a.get(y*8+5).getSubFamily(),a.get(y*8+5).getSuperorder(),a.get(y*8+5).getSynonyms(),selector);
